...
<body>
	...
	<div id="container" class="clearfix">
		...
		<div class="rightsidebar_box rt">
			<div class="rs_header">
				<span><a href="${pageContext.request.contextPath}/user/showPerson.do">我的信息</a></span> <span
			...
			<div class="rs_content">
				...
				<div class="save_password">
					<a href="#" onclick="updatePwd()" style="color:white;">保存更改</a>
				</div>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
	...
	function updatePwd(){
		...
		if(cpwdLength(oldPwd)&&cpwdLength(npwd)&&cpwdLength(cpwd)&&cpwdE()){
			$.ajax({
				"url":"${pageContext.request.contextPath}/user/updatePassword.do",
				"data":"oldPassword="+oldPwd+"&newPassword="+npwd,
				"type":"POST",
				"dateType":"json",
	...
	$("#confirmPassword").blur(function(){
		...
		if(cpwdLength(value)){
			...
			if(!cpwdE()){
				$("#confirmPasswordSpan").html("密码不匹配");
				$("#confirmPasswordSpan").css("color","red");
			}else{
				$("#confirmPasswordSpan").html("密码匹配");
				$("#confirmPasswordSpan").css("color","grean");
