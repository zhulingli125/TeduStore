...
<header id="top" class="fixed_nav">
    ...
    <div id="top_input" class="lf">
        <input id="input" type="text" placeholder="请输入您要搜索的内容" value="${title}" style="width:380px;"/>
        <a class="rt" onclick="search1()"><img id="search" src="${pageContext.request.contextPath}/images/header/search.png" alt="搜索"/></a>
    </div>
    <div class="rt">
        <ul class="lf">
