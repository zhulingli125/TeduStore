...
<body>
	...
	<div id="container" class="clearfix">
		...
		<div class="rightsidebar_box rt">
			<div class="rs_header">
				<span class="rs_header_active"> <a
					href="${pageContext.request.contextPath}/user/showPerson.do">
						我的信息 </a></span> <span> <a
					href="${pageContext.request.contextPath}/user/showPassword.do"">
						安全管理 </a></span>
			</div>
			...
			<form id="person_form" method="post" enctype="multipart/form-data">
				...
				<div class="rs_content_headPortrait">
					...
					<input type="file" id="file" name="file"
						style="float: right; margin-right: 300px" onchange="showImage()">
			...
			<form id="person_form" method="post">
				<div class="rs_content">
					...
					<div class="rs_content_sex">
						<span class="same">性别：</span> <input type="radio" name="gender"
							id="gender"
							<c:if test="${user.gender==0}">
            		checked="checked" 
            	</c:if>
							value="0"> 女 <input type="radio" name="gender"
							id="gender"
					...
					<!--保存按钮-->
					<div class="save">
						<a onClick="updatePerson()" style="color: #fff"> 保存更改 </a>
					</div>
				</div>
			</form>
		</div>
...
<script type="text/javascript">
	...
	function showImage() {
		...
		$.ajax({
			"url" : "${pageContext.request.contextPath}/user/uploadImage.do",
			"data" : formData,
			"type" : "POST",
			"dataType" : "json",
			"contentType" : false,
	...
	$(function() {
		...
		$("#leftsidebar_box .count_managment")
				.find('img')
				.attr("src",
