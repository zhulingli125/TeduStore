					...
					<div id="content_box">
						...
						<c:forEach items="${cvlist}" var="cv">
							<div class="imfor">
								...
								<div class="pudc">
									<div class="pudc_information" id="${cv.cartId}">
										<img src="../${cv.image}" width="84px" height="84px" class="lf" /> <input
								...
								<div class="pices">
									...
									<p class="pices_information">
										<b>￥</b><span>${cv.price} <input type="hidden" name=""
											value=""></span>
									</p>
								</div>
								<div class="num">
									<span class="reduc">&nbsp;-&nbsp;</span><input type="text"
										style="width: 40px;text-align:center;" value="${cv.count}"><span class="add">&nbsp;+&nbsp;</span>
								</div>
								<div class="totle">
									<span>￥</span> <span class="totle_information">${cv.price*cv.count}</span>
								</div>
								<div class="del">
									<!-- <div>
